...
public class VegetableToVegetable extends Activity implements OnClickListener{

	TableRow tableRow;

	ImageView image1, image2, image3, image4, image5, second, source, first;
	...
	public String[] vegetableName = { "BEET/चुक़ंदर", "BROCOLLI/ब्रोकोल्‍ली", "CABBAGE/गोभी", "CARROT/गाजर",
			"CORN/भुट्टा", "CUCUMBER/खीरा", "EGGPLANT/बैंगन", "GARLIC/लहसुन", "CAPSICUM/शिमला मिर्च", "ONION/प्याज",
			"PEA/मटर", "POTATO/आलू", "PUMPKIN/कद्दू", "RED PEPPER/लाल मिर्च", "TOMATO/टमाटर" };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gameover = new Intent("com.iitk.vegetable_hinglish.GameOver");
	...
	private void createNextScreen() {
		...
		handler.postDelayed(new Runnable() {
			...
			public void run() {
				...
				first = (ImageView) findViewById(R.id.firstVeg2Veg);
				first.setImageResource(gameBoard[sequenceNumber]);
				first.setTag(gameBoard[sequenceNumber]);
				first.getLayoutParams().width = 400;
				first.getLayoutParams().height = 200;

				second = (ImageView) findViewById(R.id.secondVeg2Veg);
	...
	private void gameLogic() {
		...
		try {
			if (source.getTag().equals(first.getTag())) {
				...
				second.getLayoutParams().width = 400;
				second.getLayoutParams().height = 200;
